...
public class WeatherDisplayController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        setWeatherIconImages(myCityWeather, purposeCityWeather);
    ...
    private void setWeatherIconImages(Weather myCityWeather, Weather purposeCityWeather) {
        String imageSource = "http://openweathermap.org/img/wn/"+ myCityWeather.getWeatherData().icon+"@2x.png";
        imageMyCityToday.setImage(new Image(imageSource));

        String imageSource1 = "http://openweathermap.org/img/wn/"+ purposeCityWeather.getWeatherData().icon+"@2x.png";
        imagePurposeCityToday.setImage(new Image(imageSource1));
    }
